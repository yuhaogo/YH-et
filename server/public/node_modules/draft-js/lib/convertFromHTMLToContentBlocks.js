define('node_modules/draft-js/lib/convertFromHTMLToContentBlocks', function(require, exports, module) {
  ...
  var DraftEntity = require('node_modules/draft-js/lib/DraftEntity');
  var Immutable = require('node_modules/draft-js/node_modules/immutable/dist/immutable');
  var URI = require('node_modules/fbjs/lib/URI');
  ...
  var _require = require('node_modules/draft-js/node_modules/immutable/dist/immutable');
  ...
  function hasValidLinkText(link) {
    !(link instanceof HTMLAnchorElement) ? 'development' !== 'production' ? invariant(false, 'Link must be an HTMLAnchorElement.') : invariant(false) : void 0;
