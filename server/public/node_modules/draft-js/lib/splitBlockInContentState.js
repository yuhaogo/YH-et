define('node_modules/draft-js/lib/splitBlockInContentState', function(require, exports, module) {
  ...
  function splitBlockInContentState(contentState, selectionState) {
    !selectionState.isCollapsed() ? 'development' !== 'production' ? invariant(false, 'Selection range must be collapsed.') : invariant(false) : void 0;
